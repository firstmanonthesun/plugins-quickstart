            ...
            if len(json_string) > lenTarget:
                ...
                if len(json_string) > lenTarget:
                    ...
                    if len(json_string) > lenTarget:
                        ...
                        if len(json_string) > lenTarget:
                            json_string = aggregate_results(json_string)
    return json_string
...
def aggregate_results(json_string):
    data = json.loads(json_string)
    ...
    aggregated_data = {
        ...
        'averageDiscountPercentage': total_discountPercentage / total_invoices if total_invoices > 0 else 0,
